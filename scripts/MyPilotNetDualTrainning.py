...
if NEWMODEL:
    modelWLN = get_model_wlabel(LaneMarkerModel)
    modelPPN=get_model(input_shape=(400,400))
...
cur_modelWLN = cur_file + 'LanePilotNet_v3_r2_2'
cur_modelPPN = cur_file + 'PilotNet_v3_r2_2'
