...
class LinuxVirtualJoystick(object):
    ...
    details.
    """
    def __init__(self, name='Virtual Thrustmaster F430 Controller', bustype=0x0003,
                 vendor=0x044f, product=0xb65a, version=0x0111, events=None):
        if events is None:
            events = (
                # EV_KEY
                uinput.BTN_TRIGGER,  # X
                uinput.BTN_THUMBR,  # O
                uinput.BTN_THUMB2,  # Triangle
                uinput.BTN_TOP,  # Square
                uinput.BTN_TOP2,  # L1
                uinput.BTN_PINKIE,  # R1
                uinput.BTN_BASE,  # L2
                uinput.BTN_BASE2,  # R2
                uinput.BTN_BASE3,  # select
                uinput.BTN_BASE4,  # start
                uinput.BTN_BASE5,#ps Button
                uinput.BTN_BASE6,
                uinput.BTN_0,
                uinput.BTN_1,
                uinput.BTN_2,
                ...
                uinput.ABS_Y + (-32767, 32767, 0, 0), #brake
                uinput.ABS_RZ + (0, 65535, 0, 0),  # gas
                uinput.ABS_HAT0X + (-32767, 32767, 0, 0),
                uinput.ABS_HAT0Y + (-32767, 32767, 0, 0)
